	...
	<div class="col-lg-9 col-md-9">
		<div class="tc-tabs"><!-- Nav tabs style 1 -->
			<ul class="nav nav-tabs tab-lg-button tab-color-dark background-dark white">
				<li class="active"><a href="#p1" data-toggle="tab" aria-expanded="true"><i class="fa fa-edit bigger-130"></i>Add Skill</a></li>
			</ul>
			<!-- Tab panes -->
			<div class="tab-content">
				<div class="tab-pane fade in active" id="p1">
					...
					<?php echo form_open('/admin/skills/create', array('class'=>"form-horizontal", 'role'=>"form")); ?>
						<?php if (validation_errors()): ?>
						<div class="alert note note-danger">
							<button aria-hidden="true" data-dismiss="alert" class="close" type="button">x</button>
							<h4><i class="fa fa-warning"></i> Add Skill Errors</h4>
							<hr class="separator">
						...
						<div class="form-group">
							...
							<div class="col-sm-5">
								<input type="text" name="name" id="name" class="form-control" placeholder="e.g PHP, MySql" value="<?php echo set_value('name'); ?>">
							</div>
						</div>													
						<div class="form-group">
							...
							<div class="col-sm-4">
    							<div id="percent-spinner" class="spinner">
                                    <div class="input-group input-medium">
                                        <input type="text" name="percent" id="percent" value="<?php echo (isset($_POST['percent']))?set_value('percent'):'30'; ?>" class="spinner-input form-control input-sm">
						...
						<div class="form-group">
							...
							<div class="col-sm-4">
    							<div id="exp-spinner" class="spinner">
                                    <div class="input-group input-medium">
                                        <input type="text" name="exp" id="exp" value="1" class="spinner-input form-control input-sm">
                                        <div class="spinner-buttons input-group-btn">
                                        <button type="button" class="btn spinner-up btn-sm"><i class="fa fa-chevron-up icon-only"></i></button>
                                        <button type="button" class="btn spinner-down btn-sm"><i class="fa fa-chevron-down icon-only"></i></button>
                                        </div>
						...
						<div class="form-actions">
							<div class="form-group">
								<div class="col-sm-offset-3 col-sm-9">
									<input type="hidden" name="create_skill" value="1" />
									<button type="submit" name="submit" id="submit" class="btn btn-primary">Add Skill</button>
								</div>
							</div>
						</div>

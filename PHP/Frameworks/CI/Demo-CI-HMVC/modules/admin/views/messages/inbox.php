						...
						<div id="inbox" class="tab-pane in active">
							<div class="message-container">
								<div id="id-message-list-navbar" class="message-navbar clearfix">
									<div class="message-bar">
										<div class="message-infobar" id="id-message-infobar">
											<div class="title"><i class="fa fa-inbox"></i>Inbox <span class="badge badge-primary"><?php echo $unread_msgs; ?></span></div>
										</div>
								...
								<?php foreach($messages AS $message): ?>
									<div class="message-list">
										<div class="message-item message-unread">
											<label class="inline">
												<input type="checkbox" class="tc" /> <span class="labels"></span>
											</label>
											<i class="message-star fa fa-star-o <?php echo ($message->message_starred)?'selected':''; ?>"></i>
											<span class="sender" title="<?php echo $message->message_name; ?>"><?php echo ucwords($message->message_name); ?></span>
											<span class="time">1:33 pm</span>
											<span class="summary">
												<span class="message-flags">
												<?php if($message->message_flaged): ?>
													<i class="fa fa-flag"></i>
												<?php endif; ?>
												<?php if($message->message_replied): ?>
													<i class="fa fa-reply"></i>
												<?php endif; ?>
												</span>
												<span class="text"><?php echo $message->message_subject; ?></span>
											</span>
										</div>
									</div>
								<?php endforeach; ?>
								...
								<div class="message-footer clearfix">
									<div class="pull-left"><?php echo ($total_msgs == 1)?'1 message':"$total_msgs messages"; ?> total</div>
									<div class="pull-right">
										<div class="inline middle">page <?php echo $page; ?> of <?php echo $total_pages; ?></div>&nbsp; &nbsp;
										<ul class="pagination middle">
											<li class="<?php echo ($page<=1)?'disabled':''; ?>"><a href="#"><i class="fa fa-step-backward middle"></i></a></li>
											<li class="<?php echo ($page<=1)?'disabled':''; ?>"><a href="#"><i class="fa fa-caret-left bigger-140 middle"></i></a></li>
											
											<li><span><input value="1" maxlength="3" type="text" /> </span></li>
											
											<li class="<?php echo ($page+1 >= $total_pages)?'disabled':''; ?>"><a href="#"><i class="fa fa-caret-right bigger-140 middle"></i></a></li>
											<li class="<?php echo ($page+1 >= $total_pages)?'disabled':''; ?>"><a href="#"><i class="fa fa-step-forward middle"></i></a></li>
										</ul>
									</div>
								</div>
							</div>

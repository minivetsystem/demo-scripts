    ...
    <ul class="msglist">
        <li>
            <a href="messages.html">
            	<span class="thumb"><img alt="" src="images/thumbs/avatar1.png"></span>
        ...
        <li>
            <a href="messages.html">
            	<span class="thumb"><img alt="" src="images/thumbs/avatar2.png"></span>
                <span class="msgdetails">
        ...
        <li>
            <a href="messages.html">
            	<span class="thumb"><img alt="" src="images/thumbs/avatar3.png"></span>
                <span class="msgdetails">
                    <span class="name">John Doe</span>
                    <span class="msg">Lorem ipsum dolor sit amet, consectetur...</span>
        ...
        <li>
            <a href="messages.html">
            	<span class="thumb"><img alt="" src="images/thumbs/avatar4.png"></span>
                <span class="msgdetails">
...
<div style="display: none" class="activities" id="activities">
    <ul class="actlist">
        <li class="user new">
            <div class="msg">
